    ...
    <div class="mt-8">
      ...
      <div class="space-y-4">
        ...
        <div class="suggestion-box rounded-lg border border-gray-200 p-4">
          <div class="px-5">
            <h4 class="suggestion-heading font-semibold mb-3">Improvement Suggestions</h4>
            <ul class="space-y-2">
              <li v-for="x in personality.improvement" class="suggestion-text px-6 font-medium">
                {{ x }}
              </li>
            </ul>
          </div>
        ...
        <div class="suggestion-box rounded-lg border border-gray-200 p-4">
          <div class="px-5">
            <h4 class="suggestion-heading font-semibold mb-3">Detailed Feedback</h4>
            <p class="suggestion-text px-6 font-medium">{{ personality.feedback }}</p>
          </div>
        </div>
        ...
        <div class="suggestion-box rounded-lg border border-gray-200 p-4">
          <div class="px-5">
            <h4 class="suggestion-heading font-semibold mb-3">Traits</h4>
            <ul class="space-y-2">
